...
SELECT ID, LastName, FirstName, Gender, Username, Password, CASE WHEN Active = 1 THEN 'True' ELSE 'False' END AS Active, UserID, CreatedAt, UpdatedAt FROM tblUsers WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-1JSE1NT\\SQLEXPRESS;Initial Catalog=POSSystem;Integrated Secur" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT CreatedAt, FirstName, Gender, ID, LastName, Password, UpdatedAt, UserID, U" +
                "sername, CASE WHEN Active = 1 THEN \'True\' ELSE \'False\' END AS Active\r\nFROM   tbl" +
                "Users\r\nWHERE (ID = @ID)";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO [TblUsers] ([FirstName], [LastName], [Gender], [Username], [Password]" +
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@UpdatedAt", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UpdatedAt", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT CreatedAt, FirstName, Gender, ID, LastName, Password, UpdatedAt, UserID, U" +
        ...
        public virtual int FillBy(DsUsers.TblUsersDataTable dataTable, int ID) {
